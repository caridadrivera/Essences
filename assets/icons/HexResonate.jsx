...
// Rust edge + yellow center — the one hex silhouette reserved for resonance.
// Never reuse for avatars, cards, or tab pills (see DESIGN.md "Shapes").
const HexResonate = ({ size = 22, active = false, ...props }) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} {...props}>
    <Path
      ...
      stroke={theme.colors.rust}
      strokeWidth="1.5"
      fill={active ? theme.colors.hexYellow : "none"}
    />
  </Svg>
)

export default HexResonate
